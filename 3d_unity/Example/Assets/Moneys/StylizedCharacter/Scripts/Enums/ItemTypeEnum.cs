...
namespace NHance.Assets.Scripts.Enums
{
    ...
    public enum ItemTypeEnum
    {
        ...
        WeaponR = 10,
        [ItemTypeDescriptor(Order = 1, Category = ItemCategoryString.Head, PersistInGender = Gender.Male)]
        Beard = 11,
        [ItemTypeDescriptor(Order = 2, Category = ItemCategoryString.Head, PersistInGender = Gender.Male)]
        Brows = 12,
        [ItemTypeDescriptor(Order = 1, Category = ItemCategoryString.Head, PersistInGender = Gender.Female)]
        Piercing = 13,
        [ItemTypeDescriptor(Order = 2, Category = ItemCategoryString.Head, PersistInGender = Gender.Female)]
        Earrings = 14,
        ...
        Shoulders = 23,
        [ItemTypeDescriptor(Order = 9, Type = ItemCategory.Skin, PersistInGender = Gender.Female)]
		FemBrows = 24,
