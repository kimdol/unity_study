...
namespace NHance.Assets.Scripts
{
    ...
    public class NHAvatarEditor : Editor
    {
        ...
        private void DrawSetup()
        {
            ...
            _instance.characterPrefix = EditorGUILayout.TextField("Character Prefix", _instance.characterPrefix);
            _instance.Gender = GUIUtils.DrawEnumWithLabel(_instance.Gender, "Gender");
            ...
            if (_instance.Gender == Gender.Female)
            ...
            if (_instance.FoldoutBodyPartSetup)
            {
                ...
                {
                    if (_instance.Gender == Gender.Male && e.Type == TargetBodyparts.FemBrows)
                        continue;
